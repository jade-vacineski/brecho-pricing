...
export default function PriceCalculator({ variant = 'default' }: PriceCalculatorProps) {
  const wrapperClass =
    variant === 'compact' ? 'calculator calculator--compact' : 'container';
  ...
  return (
    <div className={wrapperClass}>
      <section className="brand">
        ...
        <h1>SecondPrice</h1>
        <p>
          Gere um preço sugerido pela IA usando custo de compra, condição, categoria
          e marca. Minimalista, direto e fácil de ajustar.
        </p>
